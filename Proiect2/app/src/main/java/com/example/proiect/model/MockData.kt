...
object MockData {
    ...
    var templateMessage: List<String> = listOf(
        "M-am pierdut", "Sunt ametit","Am cazut","Am uitat ce trebuia sa fac", "Nu imi gasesc rudele","Sunt la spital",
        "Unde sunt?","Am cazut","Mi-e rau","Ma doare capul"
    )

    var casualTemplate: List<String> = listOf(
        "Ce faci?", "Cum esti?","Ce ai mai facut?", "Eu sunt bine","Sunt la spital", "Vreau sa merg la o plimbare",
